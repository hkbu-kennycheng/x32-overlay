...
inherit systemd toolchain-funcs autotools flag-o-matic multilib-minimal
...
COMMON_DEPEND="
	...
	nftables? (
		>=net-libs/libmnl-1.0:=[${MULTILIB_USEDEP}]
		>=net-libs/libnftnl-1.2.6:=[${MULTILIB_USEDEP}]
	)
...
multilib_src_install() {
	...
	into /
	dosbin ${S}/iptables/iptables-apply
	dosym iptables-apply /sbin/ip6tables-apply
	doman iptables/iptables-apply.8

	insinto /usr/include
	doins ${S}/include/ip{,6}tables.h
	insinto /usr/include/iptables
	doins ${S}/include/iptables/internal.h
...
multilib_src_install_all() {
	...
	dodoc ${S}/iptables/iptables.xslt
}
